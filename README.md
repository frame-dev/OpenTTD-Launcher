...
CI covers current Apple Silicon macOS, macOS 14 Apple Silicon, macOS 15 Intel, Windows, and Linux. On Macs, the current release and the older Intel-only 1.10.3 release execute their help command after installation, covering Rosetta on Apple Silicon as well as native Intel execution. This does not guarantee full gameplay or compatibility with every past/future macOS release.
